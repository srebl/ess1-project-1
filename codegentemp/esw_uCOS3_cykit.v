...
module top ;
	...
	wire [0:0] tmpOE__OLED_C_MOSI_net;
	wire [0:0] tmpFB_0__OLED_C_MOSI_net;
	wire [0:0] tmpIO_0__OLED_C_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_MOSI_net;
	electrical [0:0] tmpSIOVREF__OLED_C_MOSI_net;

	cy_psoc3_pins_v1_10
		#(.id("beb3c075-b77b-4525-be87-048cae4e3f5a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_MOSI
		 (.oe(tmpOE__OLED_C_MOSI_net),
		  .y({Net_23}),
		  .fb({tmpFB_0__OLED_C_MOSI_net[0:0]}),
		  .io({tmpIO_0__OLED_C_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_C_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_C_MISO_net;
	wire [0:0] tmpIO_0__OLED_C_MISO_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_MISO_net;
	electrical [0:0] tmpSIOVREF__OLED_C_MISO_net;

	cy_psoc3_pins_v1_10
		#(.id("9df0c514-0af1-4fc2-8fde-0b7d8883260c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_MISO
		 (.oe(tmpOE__OLED_C_MISO_net),
		  .y({1'b0}),
		  .fb({Net_19}),
		  .io({tmpIO_0__OLED_C_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_C_MISO_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OLED_C_SCK_net;
	wire [0:0] tmpFB_0__OLED_C_SCK_net;
	wire [0:0] tmpIO_0__OLED_C_SCK_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_SCK_net;
	electrical [0:0] tmpSIOVREF__OLED_C_SCK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("83b2fde2-60ad-45b6-9e5c-cb3baa6e3f9a"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_SCK
		 (.oe(tmpOE__OLED_C_SCK_net),
		  .y({Net_25}),
		  .fb({tmpFB_0__OLED_C_SCK_net[0:0]}),
		  .io({tmpIO_0__OLED_C_SCK_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_C_SCK_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_SCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_SCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OLED_C_CS_net;
	wire [0:0] tmpFB_0__OLED_C_CS_net;
	wire [0:0] tmpIO_0__OLED_C_CS_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_CS_net;
	electrical [0:0] tmpSIOVREF__OLED_C_CS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_CS
		 (.oe(tmpOE__OLED_C_CS_net),
		  .y({Net_163}),
		  .fb({tmpFB_0__OLED_C_CS_net[0:0]}),
		  .io({tmpIO_0__OLED_C_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_C_CS_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_C_Enable_net;
	wire [0:0] tmpFB_0__OLED_C_Enable_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_Enable_net;
	electrical [0:0] tmpSIOVREF__OLED_C_Enable_net;

	cy_psoc3_pins_v1_10
		#(.id("f98651d2-d9d5-4751-979c-2d12c8ad99a9"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_Enable
		 (.oe(tmpOE__OLED_C_Enable_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_C_Enable_net[0:0]}),
		  .io({Net_95}),
		  .siovref(tmpSIOVREF__OLED_C_Enable_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_Enable_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_Enable_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_C_DC_net;
	wire [0:0] tmpFB_0__OLED_C_DC_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_DC_net;
	electrical [0:0] tmpSIOVREF__OLED_C_DC_net;

	cy_psoc3_pins_v1_10
		#(.id("a2872507-0eef-4022-a3cf-c72bd9b1a8bb"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_DC
		 (.oe(tmpOE__OLED_C_DC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_C_DC_net[0:0]}),
		  .io({Net_96}),
		  .siovref(tmpSIOVREF__OLED_C_DC_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_DC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_DC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_C_Reset_net;
	wire [0:0] tmpFB_0__OLED_C_Reset_net;
	wire [0:0] tmpINTERRUPT_0__OLED_C_Reset_net;
	electrical [0:0] tmpSIOVREF__OLED_C_Reset_net;

	cy_psoc3_pins_v1_10
		#(.id("e6a76205-36e4-4219-945d-b9b9342ab5bc"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_C_Reset
		 (.oe(tmpOE__OLED_C_Reset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_C_Reset_net[0:0]}),
		  .io({Net_97}),
		  .siovref(tmpSIOVREF__OLED_C_Reset_net),
		  .interrupt({tmpINTERRUPT_0__OLED_C_Reset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_C_Reset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
