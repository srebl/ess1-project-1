...
#define  APP_CFG_TASK_INPUT_PRIO                       3u
#define  APP_CFG_TASK_DISPLAY_PRIO                     3u
...
#define  APP_CFG_TASK_INPUT_STK_SIZE                   128u
...
#define  APP_CFG_TASK_INPUT_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_INPUT_STK_SIZE_LIMIT           (APP_CFG_TASK_INPUT_STK_SIZE  * (100u - APP_CFG_TASK_INPUT_STK_SIZE_PCT_FULL))  / 100u
